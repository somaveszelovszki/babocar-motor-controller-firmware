...
constexpr micro::radian_t FRONT_STEERING_SERVO_POSITIVE_TRANSFER_RATE =
    micro::milliradian_t(0.12965f);
constexpr micro::radian_t FRONT_STEERING_SERVO_NEGATIVE_TRANSFER_RATE =
    micro::milliradian_t(0.12979f);
...
constexpr micro::radian_t REAR_STEERING_SERVO_POSITIVE_TRANSFER_RATE =
    micro::milliradian_t(0.12901f);
constexpr micro::radian_t REAR_STEERING_SERVO_NEGATIVE_TRANSFER_RATE =
    micro::milliradian_t(0.12779f);
